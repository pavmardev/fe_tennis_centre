<template>
  <body class="bg-gray-50 text-black antialiased">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div class="space-y-3">
        <div class="bg-white border border-black/10 rounded p-4 sm:p-5">
          <div class="flex items-start justify-between gap-3 flex-wrap">
            <div class="flex items-start gap-3">
              <div
                class="mt-0.5 w-9 h-9 rounded bg-[#8dc707]/15 flex items-center justify-center shrink-0"
              >
                <span class="text-xs font-black text-[#5a8000]">CL</span>
              </div>
              <div>
                <div class="flex items-center gap-2 flex-wrap">
                  <span class="font-black text-black">Court 1 (Clay)</span>
                  <span
                    class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-emerald-500/10 text-emerald-600"
                  >
                    Confirmed
                  </span>
                </div>
            ...
            <div class="flex items-center gap-3">
              <span class="font-black text-black text-lg">$45</span>
              <span class="text-xs text-black/30">#RES-9402</span>
              <button class="text-xs text-red-500 hover:text-red-700 font-bold transition-colors">
                Cancel
              </button>
            </div>
          </div>
          ...
          <div class="flex items-start justify-between gap-3 flex-wrap">
            <div class="flex items-start gap-3">
              <div
                class="mt-0.5 w-9 h-9 rounded bg-[#8dc707]/15 flex items-center justify-center shrink-0"
              >
                <span class="text-xs font-black text-[#5a8000]">GR</span>
              </div>
              <div>
                <div class="flex items-center gap-2 flex-wrap">
                  <span class="font-black text-black">Court 3 (Grass)</span>
                  <span
                    class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-amber-500/10 text-amber-600"
                  >
                    Pending
                  </span>
                </div>
            ...
            <div class="flex items-center gap-3">
              <span class="font-black text-black text-lg">$30</span>
              <span class="text-xs text-black/30">#RES-9381</span>
            </div>
          </div>
        </div>
          ...
          <div class="flex items-start justify-between gap-3 flex-wrap">
            <div class="flex items-start gap-3">
              <div
                class="mt-0.5 w-9 h-9 rounded bg-[#8dc707]/15 flex items-center justify-center shrink-0"
              >
                <span class="text-xs font-black text-[#5a8000]">HA</span>
              </div>
              <div>
                <div class="flex items-center gap-2 flex-wrap">
                  <span class="font-black text-black">Court 2 (Hardcourt)</span>
                  <span
                    class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-emerald-500/10 text-emerald-600"
                  >
                    Confirmed
            ...
            <div class="flex items-center gap-3">
              <span class="font-black text-black text-lg">$29</span>
              <span class="text-xs text-black/30">#RES-9112</span>
            </div>
          </div>
        </div>
